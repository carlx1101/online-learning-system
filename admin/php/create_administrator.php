...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO account (username, password, user_type, created_at ) VALUES ('$username','$password', '$role_type','$created_at')";
    ...
    else
    {
        ...
        window.location.href = 'sub_admin.php'
        </script>";
    }
}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="container">
                                <form method = "POST" >
                                <h2>Sub-Administrator Submission Form</h2><br>
