            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav" >
                    ...
                    <br><br>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="course.php" aria-expanded="false"><i class="mdi mdi-book-multiple"></i><span
                                    class="hide-menu">Course</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="blog.php" aria-expanded="false"><i class="mdi mdi-blogger"></i><span
                                    class="hide-menu">Education Blog</span></a></li>
