                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              <li class="breadcrumb-item"><a href="sub_admin.php" class="link"><i class="mdi mdi-home-outline fs-4"></i></a></li>
                              <li class="breadcrumb-item active" aria-current="page">Sub Administrator</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Sub Administrator</h1> 
                    </div>
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            <a href="create_administrator.php" class="btn btn-success text-white" >Add Administrator</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table" id = "table-item" class = "display">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn,"SELECT * FROM account WHERE user_type = '3' ");
                                        ...
                                        {   
                                            ...
                                            echo "<td scope='col'><a href=delete_subadmin.php?id=".$row['account_id']."><i class='mdi mdi-delete' style ='color:red;'></i></a></td>";
                                            echo "</tr>";
