          ...
          while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
           {
             ...
             $sql = "INSERT INTO quiz (quiz_id, course_id, question, choice1,choice2,choice3,choice4,  answer ) 
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">All Quizz</h1> 
                    </div>
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            <!-- <a  data-toggle="collapse" href="#csv" role="button" aria-expanded="false" aria-controls="collapseExample" class="btn btn-success text-white" >Import Post (.csv)</a> -->
                            <!-- <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                Import (.csv)
                            </a> -->
                            <a href="create_mcq.php?id=<?php echo $_GET['id']?>" class="btn btn-success text-white" >Create Quiz</a>
                        </div>
                            ...
                            <table class="table" id = "table-item" class = "display">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn," SELECT * FROM quiz WHERE course_id = '$course_id'");
                                        ...
                                        {   
                                            ...
                                            echo "<td scope='col'>".$row['question']."</td>";
                                            echo "<td scope='col'>".$row['answer']."</td>";
                                            echo "<td scope='col'><a href=update_mcq.php?quiz_id=".$row['quiz_id']."&cur_id=".$course_id."><i class='mdi mdi-pencil'></i></a></td>";
                                            echo "<td scope='col'><a href=delete_mcq.php?quiz_id=".$row['quiz_id']."&cur_id=".$_GET['id']."><i class='mdi mdi-delete' style ='color:red;'></i></a></td>";
                                            echo "</tr>";
