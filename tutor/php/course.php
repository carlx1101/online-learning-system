          ...
          while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
           {
             ...
             $sql = "INSERT INTO course (course_id, title, category_id, body, price, created_at, account_id ) 
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        ...
                        <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                            ...
                            <a href="create_course.php" class="btn btn-success text-white">Create Course</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <table class="table" id = "table_items">
                                <thead>
                                    ...
                                    <th scope="col">Assessment (MCQ)</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn," SELECT course.*, category.name FROM course JOIN category USING(category_id) WHERE account_id = '$account_id'");
                                        ...
                                        while($row = mysqli_fetch_array($result))
                                        {
                                            ...
                                            echo "<td scope='col'><a href=mcq.php?id=".$row['course_id']."><i class='mdi mdi-checkbox-multiple-marked'></i></a></td>";
                                            echo "<td scope='col'><a href=update_course.php?id=".$row['course_id']."><i class='mdi mdi-pencil'></i></a></td>";
