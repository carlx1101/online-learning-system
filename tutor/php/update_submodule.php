                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="course.php" class="link"><i class="mdi mdi-home-outline fs-4"></i></a></li>
                              ...
                              <li class="breadcrumb-item active" aria-current="page"> <a href="update_submodule.php" class="link">Update Module</a></li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Update Module</h1> 
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $result = mysqli_query($conn,"SELECT * FROM topic WHERE topic_id=$id");
                                ...
                                <input type="hidden" name="id" value="<?php echo $row['topic_id'] ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="link" class="form-control" id="video" name = "video" value="<?php echo $row['video_link'] ?>" >
                                    </div> 


                                    <div class="mb-3">
                                        <label for="resource" class="form-label">Resource Link</label>
                                        <input type="link" class="form-control" id="resource" name = "resource" value="<?php echo $row['resource_link'] ?>" >
                                    </div> 
