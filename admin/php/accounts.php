          ...
          while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
           {
             ...
             $sql = "INSERT INTO account (account_id, username, password, email, user_type, created_at ) 
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2>Account Submission .csv</h2><br>
                                    ...
                                    <?php
                                        ...
                                        {   
                                            ...
                                            if ($row['user_type'] == 0)
                                            {
                                                ...
                                                echo "<td scope='col'>".$user."</td>";
                                                echo "<td scope='col'>".$row['created_at']."</td>";
                                                // echo "<td scope='col'>".$row['account_status']."</td>";
                                                echo ($row['account_status'] == 1) ? "<td scope='col'>Active</td>" : "<td scope='col'>Inactive</td>";

                                                // echo "<td scope='col'><a href=disable_account.php?id=".$row['account_id']."><i class='mdi mdi-delete' style ='color:red;'></i></a></td>";
                                                if ($row['account_status'] == 1 )
                                                {
                                                    echo "<td scope='col'><a href=disable_account.php?id=".$row['account_id']."><i class='mdi mdi-close-circle' style ='color:red;'></i></a></td>";
    
                                                }
                                                else 
                                                {
                                                   echo "<td scope='col'><a href=disable_account.php?id=".$row['account_id']."><i class='mdi mdi-check-circle' style ='color:green;'></i></a></td>";
                                            ...
                                            if ($row['user_type'] == 3)
                                            {
                                                ...
                                                {
                                                   echo "<td scope='col'><a href=enable_account.php?id=".$row['account_id']."><i class='mdi mdi-check-circle' style ='color:green;'></i></a></td>";
