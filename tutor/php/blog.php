          ...
          while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
           {
             ...
             $sql = "INSERT INTO blog (blog_id, title, body, category_id, created_at, update_at, account_id ) 
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">My Blog</h1> 
                    </div>
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            ...
                            <a href="create_blog.php" class="btn btn-success text-white" >Create Post</a>
                        </div>
                            ...
                            <table class="table" id = "table-item" class = "display">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn," SELECT blog.*, category.name FROM blog JOIN category USING(category_id) WHERE account_id = '$account_id'");
                                        ...
                                        {   
                                            ...
                                            echo "<td scope='col'>".$row['update_at']."</td>";
                                            echo "<td scope='col'><a href=update_post.php?id=".$row['blog_id']."><i class='mdi mdi-pencil'></i></a></td>";
                                            echo "<td scope='col'><a href=delete_post.php?id=".$row['blog_id']."><i class='mdi mdi-delete' style ='color:red;'></i></a></td>";
                                            echo "</tr>";
