                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">System Blog</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">All Blog</h1> 
                    </div>
                            ...
                            <table class="table" id = "table-item" class = "display">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn," SELECT blog.*, category.name FROM blog JOIN category USING(category_id)");
