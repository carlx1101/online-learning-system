                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php             
                                    $id = $_SESSION['account_id']; //intval — Get the integer value of a variable
                                    $result = mysqli_query($conn,"SELECT * FROM course WHERE account_id=$id LIMIT 3");
                                    while($row = mysqli_fetch_array($result))
                                    {
                                    ?>   
                                ...
                                <h6 class="card-title"><?php echo $row['title'] ?></h6>
                                    <p class="card-text course-body"><?php echo $row['body'] ?></p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3>Educational Blog Post</h3>

                                    <?php             
                                    $id = $_SESSION['account_id']; //intval — Get the integer value of a variable
                                    $result = mysqli_query($conn,"SELECT * FROM blog WHERE account_id=$id LIMIT 3");
                                    while($row = mysqli_fetch_array($result))
                                    {
                                    ?>    
                                <div class="card w-100">
                                <div class="card-body">
                                <h6 class="card-title"><?php echo $row['title'] ?></h6>
                                    <p class="card-text blog-body"><?php echo $row['body'] ?></p>
