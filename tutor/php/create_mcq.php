...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO quiz (question, course_id, choice1, choice2,choice3,choice4,answer ) VALUES ('$question','$course_id','$first_choice','$second_choice','$third_choice','$last_choice', '$answer')";
                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Create MCQ</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Create MCQ</h1> 
                    </div>
                                ...
                                <div class="container">
                                    <form method = "POST" enctype="multipart/form-data" >
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="title" name = "question" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="title" class="form-label">First Choice</label>
                                            <input type="text" class="form-control" id="title" name = "first" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="title" class="form-label">Second Choice</label>
                                            <input type="text" class="form-control" id="title" name = "second" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="title" class="form-label">Third Choice</label>
                                            <input type="text" class="form-control" id="title" name = "third" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="title" class="form-label">Last Choice</label>
                                            <input type="text" class="form-control" id="title" name = "last" >
                                        </div>
                                        ...
                                        <select class="form-select" aria-label="Default select example" name = "answer">
                                            ...
                                            <option value="4">Last Choice</option>
                                            </select>
                                        </div>
