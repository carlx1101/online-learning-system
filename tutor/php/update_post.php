...
<?php
    if(isset($_POST['update']))
    {
        ...
        if (!empty($image))
        {
            ...
            $sql = "UPDATE blog SET title = '$title', body = '$body', category_id = '$category', image = ?, update_at = '$update_at' WHERE blog_id = $_GET[id]";
        ...
        else 
        {
            ...
            $sql = "UPDATE blog SET title = '$title', body = '$body', category_id = '$category',update_at = '$update_at ' WHERE blog_id = $_GET[id]";
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Create Blog</h1> 
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="<?php echo $row['blog_id'] ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" name = "title" Name value="<?php echo $row['title'] ?>"
 >
                                    </div>
                                    ...
                                    <div class="mb-3">
                                    <label class="form-label" for="image">Image (Current)</label><br>

                                    <?php
                                    $mysql_run=mysqli_query($conn, "SELECT * FROM blog WHERE blog_id = $id");
                                    while ($row=mysqli_fetch_assoc($mysql_run)) {
                                    echo '<div class = "d-flex" style="float:left; border:1px #000 solid; 
                                    padding-bottom:5px; margin: 5px;">';
                                    echo '<img src="data:image/jpg;base64,' . base64_encode($row['image']) . '" width="100px" height="auto"/><br>';
                                    echo '</div>'; }
                                    ?>
