...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $sql = "UPDATE category SET name = '$category_name' WHERE category_id = $category_id";
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Update Category</h1> 
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="<?php echo $row['category_id'] ?>">
                                    ...
                                    <div class="mb-3">
                                        <h2>Category Submission Form</h2><br>
                                        <label for="title" class="form-label">Category Name</label>
                                        <input type="text" class="form-control" id="title" name = "category" value="<?php echo $row['name'] ?>">
