                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page"><a href="course.php" class="link">Course</a></li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Course</h1> 
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="body"> 
                                    ...
                                    $sql = "SELECT * FROM course JOIN category ON course.category_id=category.category_id WHERE status = 1 AND course.title LIKE '%$searchKey%' AND (course.course_id NOT IN (SELECT payment_detail.course_id FROM 
                                    payment INNER JOIN payment_detail ON payment.payment_id=payment_detail.payment_id WHERE account_id=$accountID)) ORDER BY title";
                                    $records = mysqli_query($conn, $sql);
                                    ...
                                    <div class='column <?php echo $row['name'] ?>'>
                                        <div class="content mt-4 mx-4 ms-5">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                <p class="card-text pt-3"><?php echo $row['name'] ?></p>
                                                <h5 class="card-title"><?php echo $row['title'] ?></h5>
                                                <p class="desc card-text"><?php echo $row['body'] ?></p>
                                                <div class="col">
                                                    <button type="button" class="btn3 btn btn-warning me-2" style="width:100px; color:white;" data-id="<?php echo $row['course_id']?>">View</button>
                                                    <button type="button" class="btn4 btn btn-info ms-2" onclick="window.location.href= 'add_cart.php?id= <?php echo $row['course_id'] ?>'" style="width:100px; color:white;">Add Cart</button>
                                                </div>                                        
                                            </div>
                                        </div>
                                    </div>
