...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO blog (title, body, category_id, image, created_at, update_at, account_id ) VALUES ('$title','$body', '$category' ,?,'$created_at','$update_at', '$account_id')";
        ...
        {
            echo "<script>alert('Record Has ot Updated')</script>";
        }
    }
//   }
